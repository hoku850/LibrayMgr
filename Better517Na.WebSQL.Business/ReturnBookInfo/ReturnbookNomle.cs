//-----------------------------------------------------------------------
// <copyright file="ReturnbookNomle.cs" company="517Na Enterprises">
// * Copyright (C) 2014 517Na科技有限公司 版权所有。
// * version : 1.0.0.1
// * author  : shaoyu
// * FileName: ReturnbookNomle.cs
// * history : created by shaoyu 2014/1/20 9:37:43 
// </copyright>
//-----------------------------------------------------------------------
using System;
...
namespace Better517Na.LibrayMgr.Business
{
    ...
    /// 正常还书无罚款
    /// </summary>
    public class ReturnbookNomle : DbTransaction
    {
        /// <summary>
        /// 多线程数据同步锁，解决资源竞态问题
        /// </summary>
        ...
        {
            this.Issuccess = this.ReturnBook(this.bookguid);
        }

        /// <summary>
        /// 正常还书无罚款
        /// </summary>
        /// <param name="orderNum">付款姓名</param>
        /// <returns>是否成功</returns>
        private bool ReturnBook(Guid orderNum)
        {
            bool resule = false;
